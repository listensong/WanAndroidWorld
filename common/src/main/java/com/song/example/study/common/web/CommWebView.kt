...
import com.song.example.study.util.UiUtil
...
class CommWebView : WebView {
    ...
    companion object {
        ...
        @JvmStatic
        fun instance(activity: Activity): CommWebView {
            return CommWebView(activity)
        }

        @JvmStatic
        fun instance(activity: FragmentActivity): CommWebView {
            return CommWebView(activity)
        }
    }
